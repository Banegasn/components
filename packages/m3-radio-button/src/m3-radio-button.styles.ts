...
export const m3RadioButtonStyles = css`
  :host {
    ...
    --_radio-size: var(--md-comp-radio-size, 16px);
  ...
  :host([size="medium"]) {
    --_radio-outer-size: var(--md-comp-radio-outer-size, 20px);
    --_radio-inner-size: var(--md-comp-radio-inner-size, 10px);
    --_radio-ripple-size: var(--md-comp-radio-ripple-size, 48px);
  }

  :host([size="large"]) {
    --_radio-outer-size: var(--md-comp-radio-outer-size, 24px);
    --_radio-inner-size: var(--md-comp-radio-inner-size, 12px);
    --_radio-ripple-size: var(--md-comp-radio-ripple-size, 56px);
  }

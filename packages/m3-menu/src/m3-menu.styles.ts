...
export const m3MenuStyles = css`
  :host {
    ...
    z-index: 1000;
    display: block;
    top: calc(100% + var(--md-comp-menu-offset, var(--_menu-offset, 8px)));
    inset-inline-end: 0;
  }
  ...
  :host([placement="top-start"]) {
    top: auto;
    bottom: calc(100% + var(--md-comp-menu-offset, var(--_menu-offset, 8px)));
    inset-inline-start: 0;
    inset-inline-end: auto;
    transform: none;
  }
  ...
  :host([placement="right-start"]) {
    top: 0;
    bottom: auto;
    inset-inline-start: calc(100% + var(--md-comp-menu-offset, var(--_menu-offset, 8px)));
    inset-inline-end: auto;
    transform: none;
  }
  ...
  :host([placement="left-start"]) {
    ...
    bottom: auto;
    inset-inline-start: auto;
    inset-inline-end: calc(100% + var(--md-comp-menu-offset, var(--_menu-offset, 8px)));
    transform: none;
  }
  ...
  .surface {
    min-inline-size: var(--md-comp-menu-min-width, 180px);
    max-inline-size: min(280px, calc(100vw - 32px));
    max-block-size: var(--md-comp-menu-max-height, calc(100vh - 64px));
    overflow-y: auto;
    padding: 8px;
    border-radius: var(--md-comp-menu-container-shape, 16px);
